# This is an edited version of a file from dimirtyzub
# original repo: https://gist.github.com/dimitryzub/eee343faac72cb8b9894099e034381eb
...
def scrape_researchgate_publications(query: str, amount: int = 5) -> json:
